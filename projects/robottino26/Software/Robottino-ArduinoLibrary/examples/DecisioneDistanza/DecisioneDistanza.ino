...
void loop() {
  Peppino.leggiDistanza();   // necessaria per aggiornare il valore utilizzato da oggettoVicino
  
  if ( oggettoVicino() ) {                   // restituisce 1 se la distanza e' sotto una soglia preimpostata (20 cm), 0 altrimenti
